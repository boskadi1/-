...
#define CAR_SOFTWARE_VERSION           "1.61"
...
#define CAR_BLUETOOTH_TX_QUEUE_DEPTH      4U
#define CAR_BLUETOOTH_TX_MESSAGE_SIZE    96U
...
#define CAR_LOAD_ZONE_EXIT_MS          4000U
#define CAR_START_LINE_CROSS_TIMEOUT_MS 8000U
#define CAR_LINE_ENTRY_TIMEOUT_MS      5000U
#define CAR_UNLOAD_DETECT_GUARD_MS    10000U
...
#define CAR_UNLOAD_RGB_SETTLE_MS       1000U
#define CAR_UNLOAD_INITIAL_FORWARD_MS   1000U
#define CAR_UNLOAD_SWEEP_SIDE_MS         350U
#define CAR_UNLOAD_SWEEP_CROSS_MS        700U
#define CAR_UNLOAD_PREDICT_FORWARD_MS    350U
#define CAR_UNLOAD_PREDICT_SETTLE_MS     200U
...
#define CAR_LINE_KI_NUM                    1
#define CAR_LINE_KI_DEN                  200
#define CAR_LINE_I_ACCUMULATOR_MAX      1000
#define CAR_LINE_I_TERM_MAX                5
...
#define CAR_UNLOAD_ALIGN_DEADZONE_DEG     4
...
/* Wheel encoder and inner motor-speed PID.
 * PF0/PF1: front/only left encoder A/B
 * PF2/PF3: rear left encoder A/B (may be left unconnected)
 * PF4/PF5: front/only right encoder A/B
 * PF6/PF7: rear right encoder A/B (may be left unconnected)
 *
 * Both rising edges of each A/B pair are counted. When only one encoder is
 * installed on a side, the active pair is used automatically. Calibrate
 * ENCODER_COUNTS_PER_SAMPLE_AT_FULL_SPEED from the Bluetooth raw count N=. */
#define MOTOR_SPEED_CLOSED_LOOP_ENABLE                1U
#define ENCODER_SAMPLE_MS                            20U
#define ENCODER_SIGNAL_TIMEOUT_MS                   300U
#define ENCODER_COUNTS_PER_SAMPLE_AT_FULL_SPEED      40U
#define ENCODER_FEEDBACK_MAX_PERCENT                200
#define MOTOR_SPEED_PID_KP                           0.45f
#define MOTOR_SPEED_PID_KI                           0.80f
#define MOTOR_SPEED_PID_KD                           0.01f
#define MOTOR_SPEED_PID_CORRECTION_MAX               35.0f

#define ENCODER_FRONT_LEFT_A_PIN        GPIO_PIN_0
#define ENCODER_FRONT_LEFT_B_PIN        GPIO_PIN_1
#define ENCODER_REAR_LEFT_A_PIN         GPIO_PIN_2
#define ENCODER_REAR_LEFT_B_PIN         GPIO_PIN_3
#define ENCODER_FRONT_RIGHT_A_PIN       GPIO_PIN_4
#define ENCODER_FRONT_RIGHT_B_PIN       GPIO_PIN_5
#define ENCODER_REAR_RIGHT_A_PIN        GPIO_PIN_6
#define ENCODER_REAR_RIGHT_B_PIN        GPIO_PIN_7
