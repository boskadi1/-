...
# grayscale/binary continuous fitted-line processing from v1.9.
# STM32 -> OpenMV: MODE,RED or MODE,LINE
# OpenMV -> STM32: MV,LOAD,... / MV,LINE,... / MV,UNLOAD,... /
#                    MV,UNLOAD_ENTRY,...
# v2.4: independently saved unloading-area recognition version.
...
# Black unloading-circle geometry on the same processed binary image used for
# line fitting. Long tape and tape connected to an image edge are rejected.
...
def main():
    ...
    while True:
        ...
        if requested_mode != processing_mode:
            ...
            print("MODE=%s" % ("LINE" if processing_mode == MODE_LINE else "RED"))
